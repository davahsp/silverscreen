...
urlpatterns = [
    ...
    path("roles/", views.RoleSwitchView.as_view(), name="roles"),
    path("movies/<int:pk>/", views.MovieDetailView.as_view(), name="movie_detail"),
    path("booking/<int:showtime_id>/", views.BookingQuantityView.as_view(), name="booking"),
    path("booking/<int:showtime_id>/seats/", views.BookingSeatsView.as_view(), name="booking_seats"),
    ...
    path("scheduler/showtimes/<int:pk>/edit/", views.SchedulerShowTimeUpdateView.as_view(), name="scheduler_showtime_edit"),
